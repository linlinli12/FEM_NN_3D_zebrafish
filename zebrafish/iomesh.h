...
void read_ecomsol(NonDestructiveTriMesh &mesh, std::vector<Vec3d> &x, std::vector<std::vector<double> > &species_init,const char* filename);
...
void write_vtk(const NonDestructiveTriMesh &mesh, const std::vector<Vec3d> &x, const std::vector<double> &c_B, const std::vector<double> &c_C, const std::vector<double> &c_BC, const std::vector<double> &c_N,double current_time, const char* filename);
void write_vtk(const NonDestructiveTriMesh &mesh, const std::vector<Vec3d> &x, const std::vector<double> &c_BN, const std::vector<double> &c_S, const std::vector<double> &c_Tld,double current_time, const char* filename);
// ---------------------------------------------------------
//
