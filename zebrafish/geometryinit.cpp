...
void append_mesh( std::vector<Vec3st>& tris, 
                 ...
                 const std::vector<Vec3d>& new_verts,
                 const std::vector<double>& new_masses,
                 // std::vector<double>& new_c_B,
                 // std::vector<double>& new_c_C,
                 // std::vector<double>& new_c_BC,
                 // std::vector<double>& new_c_N,
                 // std::vector<double>& new_c_BN,
                 // std::vector<double>& new_c_S,
                 // std::vector<double>& new_c_Tld
                 const std::vector<std::vector<double> >& new_c_species
                 )
    ...
    for ( size_t i = 0; i < new_c_species.size(); ++i )      
    {        
        c_species.push_back( new_c_species[i] );               
    }
    // for ( size_t i = 0; i < new_c_B.size(); ++i )
    // {
    //     c_B.push_back( new_c_B[i] );
    // }

    // for ( size_t i = 0; i < new_c_C.size(); ++i )
    // {
    //     c_C.push_back( new_c_C[i] );
    // }

    // for ( size_t i = 0; i < new_c_BC.size(); ++i )
    // {
    //     c_BC.push_back( new_c_BC[i] );
    // }
    //     for ( size_t i = 0; i < new_c_N.size(); ++i )
    // {
    //     c_N.push_back( new_c_N[i] );
    // }

    // for ( size_t i = 0; i < new_c_BN.size(); ++i )
    // {
    //     c_BN.push_back( new_c_BN[i] );
    // }

    // for ( size_t i = 0; i < new_c_S.size(); ++i )
    // {
    //     c_S.push_back( new_c_S[i] );
    // }
    // for ( size_t i = 0; i < new_c_Tld.size(); ++i )
    // {
    //     c_Tld.push_back( new_c_Tld[i] );
    // }
