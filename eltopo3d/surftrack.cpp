    ...
    m_triangle_change_history()
{
    ...
    if ( false == m_allow_topology_changes )
    {
        ...
        {
            std::cerr << "WARNING: Topology changes disallowed, but non-manifold allowed.  Must disallow non-manifold surfaces ";
...
// CONSTRUCTOR with concentrations
SurfTrack::SurfTrack( const std::vector<Vec3d>& vs, 
                     const std::vector<Vec3st>& ts, 
                     const std::vector<double>& masses,
                     // const std::vector<double>& c_B,
                     // const std::vector<double>& c_C,
                     // const std::vector<double>& c_BC,
                     // const std::vector<double>& c_N,
                     // const std::vector<double>& c_BN,
                     // const std::vector<double>& c_S,
                     // const std::vector<double>& c_Tld,
                     const std::vector<std::vector<double> >& c_species,
                     const SurfTrackInitializationParameters& initial_parameters ) :
    DynamicSurface(vs, 
                   ts,
                   masses,
                   //c_B,c_C,c_BC,c_N,c_BN,c_S,c_Tld,
                   c_species,
                   initial_parameters.m_proximity_epsilon, 
                   initial_parameters.m_friction_coefficient,
                   initial_parameters.m_collision_safety ),
...
size_t SurfTrack::add_vertex( const Vec3d& new_vertex_position, double new_vertex_mass, std::vector<double> new_vertex_species)
{
    //std::cout<<"adding vertex to mesh\n";
    size_t new_vertex_index = m_mesh.add_vertex( );
    ...
    if( new_vertex_index > get_num_vertices() - 1 )
    {
        ...
        //std::cout<<"resizing vector of vectors\n";
  
        m_cspecies.resize(new_vertex_index  + 1 );
        // std::cout<<"resized vector of vectors\n";
        // m_cB.resize( new_vertex_index  + 1 );
        // m_cC.resize( new_vertex_index  + 1 );
        // m_cBC.resize( new_vertex_index  + 1 );
        // m_cN.resize( new_vertex_index  + 1 );
        // m_cBN.resize( new_vertex_index  + 1 );
        // m_cS.resize( new_vertex_index  + 1 );
        // m_cTld.resize( new_vertex_index  + 1 );
    }
    ...
    // NOTE: changing also for concentrations
    // m_cB[new_vertex_index] = new_vertex_cB;
    // m_cC[new_vertex_index] = new_vertex_cC;
    // m_cBC[new_vertex_index] = new_vertex_cBC;
    // m_cN[new_vertex_index] = new_vertex_cN;
    // m_cBN[new_vertex_index] = new_vertex_cBN;
    // m_cS[new_vertex_index] = new_vertex_cS;
    // m_cTld[new_vertex_index] = new_vertex_cTld;
    m_cspecies[new_vertex_index] = new_vertex_species;
