...
public:
    ...
    /// Alternative constructor including concentration fields
    ///
    DynamicSurface(const std::vector<Vec3d>& vs, 
                   const std::vector<Vec3st>& ts, 
                   const std::vector<double>& masses,
...
public:
    ...
    // std::vector<double>& get_cB( ) ;
    // std::vector<double>& get_cC( ) ;
    // std::vector<double>& get_cBC( ) ;
    // std::vector<double>& get_cN( ) ;
    // std::vector<double>& get_cBN( ) ;
    // std::vector<double>& get_cS( ) ;
    // std::vector<double>& get_cTld( ) ;
    std::vector<std::vector<double> >& get_cspecies( );
    ...
    // std::vector<double> m_cBC;  
    // std::vector<double> m_cN;    
    // std::vector<double> m_cBN;   
    // std::vector<double> m_cS; 
    // std::vector<double> m_cTld; 
    std::vector<std::vector<double> > m_cspecies; 
    /// The mesh graph
...
// inline  std::vector<double>& DynamicSurface::get_cB( ) 
// {
//     return m_cB;
// }

// inline  std::vector<double>& DynamicSurface::get_cC( ) 
// {
//     return m_cC;
// }

// inline  std::vector<double>& DynamicSurface::get_cBC( ) 
// {
//     return m_cBC;
// }
// inline  std::vector<double>& DynamicSurface::get_cN( ) 
// {
//     return m_cN;
// }

// inline  std::vector<double>& DynamicSurface::get_cBN( ) 
// {
//     return m_cBN;
// }

// inline  std::vector<double>& DynamicSurface::get_cS( ) 
// {
//     return m_cS;
// }
// inline  std::vector<double>& DynamicSurface::get_cTld( ) 
// {
//     return m_cTld;
// }

inline  std::vector<std::vector<double> >& DynamicSurface::get_cspecies( ) 
{
    return m_cspecies;
}
// --------------------------------------------------------
