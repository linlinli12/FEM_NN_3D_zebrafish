...
public:
    ...
    //size_t add_vertex( const Vec3d& new_vertex_position, double new_vertex_mass, double new_vertex_cB,double new_vertex_cC,double new_vertex_cBC ,double new_vertex_cN,double new_vertex_cBN,double new_vertex_cS,double new_vertex_cTld );
    size_t add_vertex( const Vec3d& new_vertex_position, double new_vertex_mass, std::vector<double> new_vertex_species);
